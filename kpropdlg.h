...
/*
class KPropTreeItem : public QListViewItem
{
  public:
    KPropTreeItem(QListView *parent,QString title,QWidget *propPage) :
      QListViewItem(parent,title)
    {
      mPropPage = propPage;
    }
    
    QWidget *propPage() { return mPropPage; }
...
protected slots:
	...
	virtual void applyConfig();
      	...
      	/** Show page associated with selected QListViewItem */
      	bool showPage( QListViewItem *item );
...
private:
	...
	QList<QListViewItem> *TreeItemList;
	QHBoxLayout *HLayout;
	QVBoxLayout *VLayout;
	QFrame *PageFrame;
	QListView *TreeList;
