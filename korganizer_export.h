...
#  define KORGANIZER_EVENTVIEWER_EXPORT_DEPRECATED KDE_DEPRECATED KORGANIZER_EXPORT
# endif

# ifndef KORGANIZER_CALENDAR_EXPORT_DEPRECATED
#  define KORGANIZER_CALENDAR_EXPORT_DEPRECATED KDE_DEPRECATED KORGANIZER_EXPORT
# endif
