    ...
    , mIdentityManager(/*ro=*/ true)
{
    ...
    connect(&mIdentityManager, &KPIMIdentities::IdentityManager::changed, this, &SearchCollectionHelper::updateOpenInvitation);
    connect(&mIdentityManager, &KPIMIdentities::IdentityManager::changed, this, &SearchCollectionHelper::updateDeclinedInvitation);
}
