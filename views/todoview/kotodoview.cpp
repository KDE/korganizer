    ...
    : BaseView(parent)
{
    ...
    connect(mView, &EventViews::TodoView::createEvent, eventPopup, &KOEventPopupMenu::createEvent);
    connect(mView, &EventViews::TodoView::createNote, eventPopup, &KOEventPopupMenu::createNote);
}
