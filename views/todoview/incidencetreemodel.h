...
#ifndef KORG_VIEWS_INCIDENCE_TREEMODEL_H
#define KORG_VIEWS_INCIDENCE_TREEMODEL_H
...
class IncidenceTreeModel : public QAbstractProxyModel
{
  ...
  Q_SIGNALS:
     ...
     * This is better than the view waiting for "rows moved" signals because
     * those signals are also sent when the model is initially populated.
     */
     ...
     *
     * One rowsInserted() signal from the ETM, will make IncidenceTreeModel
     * generate several rowsInserted(), layoutChanged() or rowsMoved() signals.
     *
