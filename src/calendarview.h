...
Q_SIGNALS:
    ...
    */
    ...
    void calendarAdded(const Akonadi::CollectionCalendar::Ptr &);
    void calendarRemoved(const Akonadi::CollectionCalendar::Ptr &);
...
protected:
    ...
    */
    ...
    void deleteRecurringIncidence(const Akonadi::Item &item);
