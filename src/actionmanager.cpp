...
void ActionManager::initActions()
{
    ...
    action->setIconText(i18nc("agenda view show 1 day at a time", "Day"));
    action->setText(i18nc("agenda view show 1 day at a time", "Day"));
    ...
    mNextXDays->setIconText(i18nc("agenda view show a few days at a time", "Next Days"));
    mNextXDays->setText(i18nc("agenda view show a few days at a time", "&Next Days"));
    mNextXDays->setStatusTip(i18nc("@info:status", "View a few days at a time"));
    mNextXDays->setToolTip(i18nc("@info:tooltip", "In Agenda View, show the next few days at a time"));
    mNextXDays->setWhatsThis(
        xi18nc("@info:whatsthis",
               "Select this option to view the next few days a a time in Agenda View. Configure the <placeholder>Next X Days</placeholder> setting in the "
    ...
    action->setIconText(i18nc("agenda view show the weekly schedule days only (eg. no weekends)", "Week Schedule"));
    action->setText(i18nc("agenda view show the the weekly schedule days only (eg. no weekends)", "Week Schedule"));
    ...
    action->setToolTip(i18nc("@info:tooltip",
                             "In Agenda View, show a week at a time excluding days that are not included in your weekly schedule (ie. weekends are excluded)"));
    ...
    action->setIconText(i18nc("agenda view show a week at a time", "Week"));
    action->setText(i18nc("agenda view show a week at a time", "Week"));
